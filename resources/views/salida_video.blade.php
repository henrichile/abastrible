                    ...
                    <div class="slider-text-middle">
                        <div class="col-md-12 col-sm-12 col-xs-12 center-col text-center">
                            <div style="width:1000px" class="center-col">
                                ...
                                <br/>
                                <div class="col-md-12 col-sm-12 col-xs-12 center-col text-center">
                            <a href="{{ route('trivia.salida')}}" class="btn btn-extra-large propClone bg-light-green text-white btn-circle margin-five-top sm-margin-five-top xs-margin-ten-top tz-text">Siguiente</a>
                        </div>
                        </div>
                    </div>                                
                </div>
